 ...
 * - GenerateItReportInput - The input type for the generateItReport function.
 * - GenerateItReportOutput - The return type for the generateItReport function.
 */
...
const GenerateItReportOutputSchema = z.object({
